...
<!-- Contact Detail Style -->
    <div class="ContactDetail">
        <div class="ContactDetail1">
            ...
            <div class="inputSt">
                <form action="#">
                    ...
                    <textarea v-model="text" id="message" placeholder="Your Message..."></textarea>
                </form>
            </div>
            <div class="Detail">
        ...
        <div class="ContactDetail2">
            ...
            <div class="info">
                <div class="greeting">
                    <p>Feel Free to contact me for any Project's Opportunities, <br>
                    StartUps or FreeLance Job XD.</p>
                </div>
                <div class="iEmail">
                    <div class="icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-mail email_icon"><rect width="20" height="16" x="2" y="4" rx="2"/><path d="m22 7-8.97 5.7a1.94 1.94 0 0 1-2.06 0L2 7"/></svg>
                    </div>
                    <div class="ScAddress1">
                        <h1>Email</h1>
                        <p>Saklysem319@gmail.con</p>
                    </div>
                </div>
                <div class="iEmail">
                    <div class="icon">
                ...
                <div class="AddSM">
                    <div class="InProfile">
                        <p>Let's Connect with my Social Media!</p>
                    </div>
                    <div class="SMIcon">
                        <p>
                            <a href="https://web.facebook.com/profile.php?id=100083211016907"></a>
                        ...
                        <p>
                            <a href="https://www.youtube.com/@lysem_sak"></a>
                        ...
                        <p>
                            <a href="https://www.behance.net/lysemsak1"></a>
                        ...
                        <p>
                            <a href="https://www.tiktok.com/@s_lysem?is_from_webapp=1&sender_device=pc"></a>
                            <svg fill="#ffffff" width="24px" height="24px" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" xml:space="preserve" stroke="#ffffff"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier">
                                <path d="M19.589 6.686a4.793 4.793 0 0 1-3.77-4.245V2h-3.445v13.672a2.896 2.896 0 0 1-5.201 1.743l-.002-.001.002.001a2.895 2.895 0 0 1 3.183-4.51v-3.5a6.329 6.329 0 0 0-5.394 10.692 6.33 6.33 0 0 0 10.857-4.424V8.687a8.182 8.182 0 0 0 4.773 1.526V6.79a4.831 4.831 0 0 1-1.003-.104z"></path></g></svg>
                        </p>
                    </div>
                </div>
            </div>
