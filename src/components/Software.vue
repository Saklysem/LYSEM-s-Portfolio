...
<div class="software">
    ...
    <div class="softwareTool">
        ...
        <div class="softwareStatus">
            ...
            <div class="AF">
                <div class="level">
                    <h1>Videographer & Photographer</h1>
                    <h1>90%</h1>
                </div>
                <div class="status">
            ...
            <div class="AF">
                <div class="level">
                    <h1>Business Suit(Ads Manager)</h1>
                    <h1>90%</h1>
                </div>
                <div class="status">
